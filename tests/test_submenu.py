...
def test_check_menu_submenus_and_dishes_count(menu_id):
    ...
    response = client.post(
        f'/api/v1/menus/{menu_id}/submenus', json=submenu_data_1)
    assert_properties(response, status_code=201)
    ...
    response = client.post(
        f'/api/v1/menus/{menu_id}/submenus', json=submenu_data_2)
    assert_properties(response, status_code=201)
    ...
    response = client.post(
        f'/api/v1/menus/{menu_id}/submenus/{submenu_id_1}/dishes', json=dish_data_1)
    client.post(
        f'/api/v1/menus/{menu_id}/submenus/{submenu_id_2}/dishes', json=dish_data_2)
    assert_properties(response, status_code=201)
